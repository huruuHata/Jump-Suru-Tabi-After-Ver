...
public:
	...
	// 備　考：シーンのDraw関数で呼び出す
	//=============================================================================
	void Draw(Engine* pEngine, const Camera* pCamera, const Projection* pProjection);
	...
	//=============================================================================
	void ChangePosition(const ParticleBase* pTargetAddress, const D3DXVECTOR3 position);
	...
	//=============================================================================
	void ChangeDirection(const ParticleBase* pTargetAddress, const D3DXVECTOR3 direction);
