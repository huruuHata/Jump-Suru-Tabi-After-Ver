...
// 　　　　const D3DXMATRIX* ビュープロジェクション変換行列のポインタ
// 　　　　const D3DXMATRIX* 回転行列（ビルボード）のポインタ
//=============================================================================
void ParticleBase::Draw(LPDIRECT3DDEVICE9 pDevice, ID3DXEffect* pEffect, const D3DXMATRIX* pMatVP, const D3DXMATRIX* pMatBillboard)
{
	//テクスチャーを渡す
