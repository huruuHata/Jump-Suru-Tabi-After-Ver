...
// 描画
// 引　数：Engine*           エンジンクラスのアドレス
// 　　　　const Camera*     カメラクラスのアドレス
// 　　　　const Projection* プロジェクションクラスのアドレス
// 備　考：シーンのDraw関数で呼び出す
//=============================================================================
void ParticleManage::Draw(Engine* pEngine, const Camera* pCamera, const Projection* pProjection)
{
	LPDIRECT3DDEVICE9 pDevice = pEngine->GetDevice();
...
//=============================================================================
void ParticleManage::ChangePosition(const ParticleBase* pTargetAddress, const D3DXVECTOR3 position)
{
	for (ParticleBase* pAddress : m_lstParticleBase) {
		if (pAddress == pTargetAddress) {
...
//=============================================================================
void ParticleManage::ChangeDirection(const ParticleBase* pTargetAddress, const D3DXVECTOR3 direction)
{
	for (ParticleBase* pAddress : m_lstParticleBase) {
		if (pAddress == pTargetAddress) {
