...
// 　　　：const bool  ループフラグ 
//=============================================================================
void DSManage::PlaySE(std::string strFileName, const DWORD priority, const bool bLoop)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
	...
	if(FAILED(pSoundBuffer->Play(0, priority, loop))) {
...
// 引　数：string ＳＥファイル名
//=============================================================================
void DSManage::ResetFrequency(std::string strFileName)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
...
// 　　　　const int 増減させる周波数
//=============================================================================
void DSManage::ChangeFrequency(std::string strFileName, const int value)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
...
// 引　数：string ＳＥファイル名
//=============================================================================
void DSManage::ResetPan(std::string strFileName)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
...
// 　　　　const int 増減させる数値
//=============================================================================
void DSManage::ChangePan(std::string strFileName, const int value)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
...
// 引　数：string ＳＥファイル名
//=============================================================================
void DSManage::ResetVolume(std::string strFileName)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
...
// 　　　　const int 増減させる数値
//=============================================================================
void DSManage::ChangeVolume(std::string strFileName, const int value)
{
	std::map< std::string, DS* >::iterator seIter = m_mapSE.find(strFileName);
