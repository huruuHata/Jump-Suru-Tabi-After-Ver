...
// 　　　　const D3DCOLORVALUE* 色　デフォルトは白
//=============================================================================
void BoundingBox::Draw(Engine* pEngine, const Camera* pCamera, const Projection* pProjection, const D3DCOLORVALUE* color)
{
	if (m_pVB && m_pIB) {
...
BB_Polygon BoundingBox::GetPolygon(const int index)
{
	...
	const D3DXVECTOR3 POLYGON_DATA[8] = {
