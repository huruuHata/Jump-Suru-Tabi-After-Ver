...
//=============================================================================
void Line::Draw(const D3DXVECTOR2* pVertexList, const DWORD dwVertexListCount, const D3DCOLOR color)
{
	m_pLine->Begin();
...
//=============================================================================
void Line::Draw(const D3DXVECTOR3 startPosition, const D3DXVECTOR3 endPosition, const D3DCOLOR color, const D3DXMATRIX* pView, const D3DXMATRIX* pProjection)
{
	Line3DData line[2];
