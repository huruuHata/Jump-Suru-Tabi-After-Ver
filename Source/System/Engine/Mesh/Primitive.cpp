...
//=============================================================================
// 三角ポリゴン（１つ）の作成
// 　　　　const D3DXVECTOR3[3] ポリゴンを構成する３頂点の座標（配列）
...
//=============================================================================
// テクスチャの設定
// 引　数：LPDIRECT3DTEXTURE9 テクスチャーのポインタ
//=============================================================================
void Primitive::SetTexture(LPDIRECT3DTEXTURE9 pTexutre)
{
	m_pTexture = pTexutre;
}
...
// 　　　　const Camera*           カメラクラスのポインタ
// 　　　　const Projection*       プロジェクションクラスのポインタ
// 　　　　const AmbientLight*     アンビエントライトクラスのポインタ
// 　　　　const DirectionalLight* ディレクショナルライトのポインタ
//=============================================================================
void Primitive::Draw(Engine* pEngine, const Camera* pCamera, const Projection* pProjection, const AmbientLight* pAmbient, const DirectionalLight* pLight)
{
	if (!pAmbient) {
	...
	//ワールド転置逆行列を渡す
	m_pEffect->SetMatrix("gMatWIT", &matWIT);
