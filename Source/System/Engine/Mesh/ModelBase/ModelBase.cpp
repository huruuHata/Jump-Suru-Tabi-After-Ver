...
//=============================================================================
// アニメーションコントローラーのクローン
// 戻り値：ID3DXAnimationController* クローンされたアニメーションコントローラーのポインタまたはnullptr
//=============================================================================
...
//=============================================================================
// モデルデータの描画
// 引　数：const LPD3DXMATRIX   ワールド座標変換マトリックスへのポインタ
// 　　　　const LPD3DXMATRIX   ビュープロジェクション変換マトリックスへのポインタ
// 　　　　const D3DCOLORVALUE* アンビエントライトの色へのポインタ
// 　　　　const D3DLIGHT9*     ライトへのポインタ
//=============================================================================
void ModelBase::Draw(const LPD3DXMATRIX pMatWorld, const LPD3DXMATRIX pMatVP, const D3DCOLORVALUE* pAmbient, const D3DLIGHT9* pLight)
{
	//アンビエントライトの色を渡す
...
//=============================================================================
// ルートフレームの変換マトリックスを取得
// 戻り値：：LPD3DXMATRIX 変換マトリックスのポインタ
//=============================================================================
D3DXMATRIX ModelBase::GetMatrixFromRootFrame()
{
	D3DXFRAME_DERIVED* pFrame = *((D3DXFRAME_DERIVED**)m_pFrame->GetRootFramePointerAddress());
...
// 引　数：string  フレーム名
//=============================================================================
D3DXMATRIX ModelBase::GetMatrixFromFrameName(std::string strFrameName)
{
	D3DXFRAME_DERIVED* pFrame = (D3DXFRAME_DERIVED*)m_pFrame->GetFrame(strFrameName.c_str());
...
// 戻り値：bool 成功 true、失敗 false
// 引　数：const D3DXVECTOR3* 現在位置座標へのポインタ
...
// 引　数：const D3DXVECTOR3& 現在位置座標への参照
//		　 const D3DXVECTOR3& キャラクターの向きへの参照
...
//-----------------------------------------------------------------------------
// 衝突判定　レイとポリゴンの交点を求める
// 戻り値：bool 交差している場合 true、していない場合 false
