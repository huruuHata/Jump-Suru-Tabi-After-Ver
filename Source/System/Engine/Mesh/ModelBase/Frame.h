...
public:
	...
	//=============================================================================
	void DrawFrame(LPD3DXFRAME pFrame, const LPD3DXMATRIX pMatVP, ID3DXEffect* pEffect);
...
private:
	...
	//         ID3DXEffect*        エフェクトへのポインタ
	//-----------------------------------------------------------------------------
	void DrawMeshContainer(LPD3DXMESHCONTAINER pMeshContainerBase, LPD3DXFRAME pFrameBase, const LPD3DXMATRIX pMatVP, ID3DXEffect* pEffect);
