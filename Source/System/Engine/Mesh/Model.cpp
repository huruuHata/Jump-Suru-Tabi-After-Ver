...
//=============================================================================
void Model::Draw(const Camera* pCamera, const Projection* pProjection, const AmbientLight* pAmbient, const DirectionalLight* pLight, const bool bAnimation)
{
	...
	D3DXMATRIX matProj = pProjection->GetProjectionMatrix();
...
//=============================================================================
D3DXMATRIX Model::GetMatrixFromRootFrame()
{
	return m_pModelBase->GetMatrixFromRootFrame();
}
...
// 引　数：string フレーム
//=============================================================================
D3DXMATRIX Model::GetMatrixFromFrameName(std::string strFrameName)
{
	return m_pModelBase->GetMatrixFromFrameName(strFrameName);
}
