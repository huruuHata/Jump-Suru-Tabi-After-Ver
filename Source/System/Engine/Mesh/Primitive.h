...
public:
	...
	//=============================================================================
	void SetTexture(LPDIRECT3DTEXTURE9 pTexutre);
	...
	//=============================================================================
	void Draw(Engine* pEngine, const Camera* pCamera, const Projection* pProjection, const AmbientLight* pAmbient = nullptr, const DirectionalLight* pLight = nullptr);
