...
//
// 2021/11/08 色用定数COLOR_××を使うため"Color.h"をインクルード
//
...
//#define SE_USE_DMUSIC
#define SE_USE_DSOUND
...
#include "Line\\Line.h"
#include "Input\\InputManage.h"
#include "Texture\\TextureManage.h"
#include "Font\\FontManage.h"
#include "BGM\\BGMManage.h"

#ifdef SE_USE_DMUSIC
#include "SE\\SEManage.h"
#endif

#ifdef SE_USE_DSOUND
#include "SE\\DSManage.h"
#endif

#include "Mesh\\ModelBase\\ModelManage.h"
...
public:
	...
	//=============================================================================
	void Clear(const D3DCOLOR backgroundColor);
	...
	//=============================================================================
	void Blt(const RECT* pDest, std::string strFileName, const RECT* pSour, const DWORD alpha = 255, const float angle = 0.0f);
	...
	// 　　　　string         表示文字
	//=============================================================================
	void DrawString(const int x, const int y, std::string strFontName, const D3DCOLOR argb, std::string strMessage);
	...
	// 　　　　string         表示文字
	//=============================================================================
	void DrawString(RECT* pDest, std::string strFontName, const D3DCOLOR argb, std::string strMessage);
	...
	//=============================================================================
	void AddTexture(std::string strFileName, D3DCOLOR colorKey = Texture::COLORKEY_PURPLE);
	...
	//=============================================================================
	void AddFont(std::string strSizeAndFontName);
	...
	//=============================================================================
	void LoadBGM(std::string strFileName);

	//=============================================================================
	// ＢＧＭの解放（省メモリ対策）
	// 備　考：プレイ中にＢＧＭの解放を行うと一瞬処理が停止するため、
	// 　　　　プレイ中のＢＧＭ解放には注意すること。
	//=============================================================================
	void ReleaseBGM();
	...
	// 引　数：string ＢＧＭファイル名
	//=============================================================================
	bool IsPlayingBGM(std::string strFileName);
	...
	//=============================================================================
	void PlaySE(std::string strFileName, const DWORD priority = 0, const bool bLoop = false);
#endif
	...
	// 引　数：string ＳＥファイル名
	//=============================================================================
	void ResetSEFrequency(std::string strFileName);
	...
	// 　　　　const int 増減させる周波数
	//=============================================================================
	void ChangeSEFrequency(std::string strFileName, const int value);

	//=============================================================================
	// ＳＥのパンをリセット
	// 引　数：string ＳＥファイル名
	//=============================================================================
	void ResetSEPan(std::string strFileName);
	...
	// 　　　　const int 増減させる数値
	//=============================================================================
	void ChangeSEPan(std::string strFileName, const int value);

	//=============================================================================
	// ＳＥのボリュームをリセット
	// 引　数：string ＳＥファイル名
	//=============================================================================
	void ResetSEVolume(std::string strFileName);
	...
	// 　　　　const int 増減させる数値
	//=============================================================================
	void ChangeSEVolume(std::string strFileName, const int value);
#endif
	...
	//=============================================================================
	void AddModel(std::string strFileName, const bool bCreateAdjacencyData = false);
	...
	//=============================================================================
	bool GetMouseButton(const BYTE diKey) const;
	...
	//=============================================================================
	DIJOYSTATE GetPadState(const unsigned int index);
	...
	// 　　　　const unsigned int ボタン番号（０～３１）
	//=============================================================================
	bool GetPadButtonSync(const unsigned int idxPad, const unsigned int idxButton) const;
	...
	// 　　　　const D3DCOLOR    線の色
	//=============================================================================
	void DrawLine(const D3DXVECTOR2 startPosition, const D3DXVECTOR2 endPosition, const D3DCOLOR color);
	...
	// 　　　　const D3DCOLOR 線の色
	//=============================================================================
	void DrawLine(const int startX, const int startY, const int endX, const int endY, const D3DCOLOR color);
	...
	//=============================================================================
	void DrawLine(const D3DXVECTOR3 startPosition, const D3DXVECTOR3 endPosition, const D3DCOLOR color, const D3DXMATRIX* pView, const D3DXMATRIX* pProjection);
	...
	// 　　　　const D3DCOLOR    線の色
	//=============================================================================
	void DrawCircle(const D3DXVECTOR2 center, const float radius, const int segment, const D3DCOLOR color);
	...
	//=============================================================================
	void ImGuiBegin(ImVec2 position, ImVec2 size, ImGuiWindowFlags flags = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove);
	...
	// 引　数：string& 文字列の参照
	//=============================================================================
	bool ImGuiInput(std::string caption, std::string& input);
#endif
...
private:
	...
	//スクリーンショット保存用フォルダ名
	const std::string SCREENSHOT_FOLDER;
	...
	//2D用テクスチャ管理クラスポインタ
	TextureManage* m_pClsTextureManage;

	//フォント管理クラスポインタ
	FontManage* m_pClsFontManage;

	//ＢＧＭ管理クラスポインタ
	BGMManage* m_pClsBGMManage;

#ifdef SE_USE_DMUSIC
	//ＳＥ管理クラスポインタ
	SEManage* m_pClsSEManage;
#endif

#ifdef SE_USE_DSOUND
	DSManage* m_pClsSEManage;
#endif

	//モデル管理クラスポインタ
	ModelManage* m_pClsModelManage;

	//線描画クラス
	Line* m_pClsLine;

	//テクスチャフリーサイズフラグ
	bool m_bFreeSizeTexture;
...
#ifndef IMGUI_DISABLE
//Imgui　日本語用グラフレンジ（元々用意されているものだと足りない（らしい））
