...
//
// 2024/10/28　GetMatrixFromTwoVector関数の引数をポインタに変更
//
//*****************************************************************************
...
// 戻り値：回転行列
// 引　数：const D3DXVECTOR3*　ベクトル１のアドレス
// 　　　　const D3DXVECTOR3*　ベクトル２のアドレス
//=============================================================================
D3DXMATRIX GetMatrixFromTwoVector(const D3DXVECTOR3* pV1, const D3DXVECTOR3* pV2)
{
	D3DXVECTOR3 a = D3DXVec3Normalize(pV1);
	D3DXVECTOR3 b = D3DXVec3Normalize(pV2);
