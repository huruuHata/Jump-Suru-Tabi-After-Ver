...
//
// 2024/10/15 PostEffect関数をPostEffectForBeginners関数に名称変更
//
// 2024/10/22 PreparePostEffect関数を追加
//
//*****************************************************************************
...
public:
	...
	//シーン定数（GameData.hで定義　Common::SCENE_○○）
	int m_scene;
	...
	// 　　　　Scene* const サブシーンへ飛ぶ場合に前のシーンのポインタを格納する
	//=============================================================================
...
public:
	...
	//=============================================================================
	// シーンの実行時に繰り返し呼び出されるポストエフェクト（シェーダー）準備関数（純粋仮想関数）
	//=============================================================================
	virtual void PreparePostEffect() = 0;

	//=============================================================================
	// Run関数内で実行される初心者用ポストエフェクト用関数（純粋仮想関数）
	//=============================================================================
	virtual void PostEffectForBeginners() = 0;
